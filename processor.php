...
require 'E:/movies/parent/htdocs/Todo list/PHPMailer-6.9.3/src/Exception.php';
require 'E:/movies/parent/htdocs/Todo list/PHPMailer-6.9.3/src/PHPMailer.php';
require 'E:/movies/parent/htdocs/Todo list/PHPMailer-6.9.3/src/SMTP.php';
...
function sendVerificationEmail($email, $otp) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'd919038229c79c'; // Replace with your Mailtrap username
        $mail->Password = 'd6ec6e33961590'; // Replace with your Mailtrap password
...
if (isset($_POST['action'])) {
    ...
    if ($action === 'register') {
        ...
        if ($user && $user['otp'] === $otp && strtotime($user['otp_expiry']) > time()) {
            ...
            // Redirect to login page (Todolist.html) after successful verification
        ...
        if ($stmt->num_rows > 0) {
            ...
            // Redirect to Todolist.html after successful login
            header("Location: Todolist.html");
            exit();
        } else {
